...
const Masportafolios = () => {
  ...
  React.useEffect(() => {
    const fetchPortafolios = async () => {
      let res = await fetch(`https://fotogavi-app.herokuapp.com/api/Design/${link}`);
  ...
  React.useEffect(() => {
    const fetchImagenes = async () => {
      let res = await fetch(
        `https://fotogavi-app.herokuapp.com/api/Design/${link}/imagenes`
      );
  ...
  return (  
    ...
    <React.Fragment>
      ...
      <div className="galImagen"> <GaleriaList Imagenes={Imagenes} /></div>
